...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <img src="https://cdn.vectorstock.com/i/preview-lt/34/45/pt-geometric-bold-concept-logo-initial-concept-vector-44483445.webp" width="30" height="30" class="d-inline-block align-top" alt="">
  Project|Tracker
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="getProject.do">Find All Projects</a>
      </li>
